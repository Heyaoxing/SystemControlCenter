        ...
        private string BuildGoToPageSection()
        {
            ...
            if (_pagerOptions.PageIndexBoxType == PageIndexBoxType.DropDownList)
            {
                ...
                piBuilder.AppendFormat(
                    "<input type=\"text\" value=\"{0}\" style=\"width: 60px\" class=\"input-sm\" data-pageindexbox=\"true\"{1}/>", _pageIndex, (_pagerOptions.ShowGoButton ? "" : " data-autosubmit=\"true\""));
            string outHtml;
            ...
            {
                piBuilder.AppendFormat("<input type=\"button\" class=\"input-sm\" data-submitbutton=\"true\" value=\"{0}\"/>", _pagerOptions.GoButtonText);
            }
