        ...
        private string BuildGoToPageSection()
        {
            ...
            if (_pagerOptionsEn.PageIndexBoxType == PageIndexBoxType.DropDownList)
            {
                ...
                piBuilder.AppendFormat(
                    "<input type=\"text\" value=\"{0}\"  style=\"width: 60px\" class=\"form-control\" data-pageindexbox=\"true\"{1}/>", _pageIndex, (_pagerOptionsEn.ShowGoButton ? "" : " data-autosubmit=\"true\""));
            string outHtml;
            ...
            {
                piBuilder.AppendFormat("<input class=\"btn btn-default\" type=\"button\" data-submitbutton=\"true\" value=\"{0}\"/>", _pagerOptionsEn.GoButtonText);
            }
